  ...
  return (
    <Container>
      <svg xmlns="http://www.w3.org/2000/svg" width="5em" height="5em" viewBox="0 0 24 24">
        <g>
          <circle cx="12" cy="3" r="1" fill={theme.primary}>
            <animate
          ...
          <circle cx="16.5" cy="4.21" r="1" fill={theme.primary}>
            <animate
          ...
          <circle cx="7.5" cy="4.21" r="1" fill={theme.primary}>
            <animate
          ...
          <circle cx="19.79" cy="7.5" r="1" fill={theme.primary}>
            <animate
          ...
          <circle cx="4.21" cy="7.5" r="1" fill={theme.primary}>
            <animate
          ...
          <circle cx="21" cy="12" r="1" fill={theme.primary}>
            <animate
          ...
          <circle cx="3" cy="12" r="1" fill={theme.primary}>
            <animate
          ...
          <circle cx="19.79" cy="16.5" r="1" fill={theme.primary}>
            <animate
          ...
          <circle cx="4.21" cy="16.5" r="1" fill={theme.primary}>
            <animate
          ...
          <circle cx="16.5" cy="19.79" r="1" fill={theme.primary}>
            <animate
          ...
          <circle cx="7.5" cy="19.79" r="1" fill={theme.primary}>
            <animate
          ...
          <circle cx="12" cy="21" r="1" fill={theme.primary}>
            <animate
